...
class KitchenViewController: BaseViewController {
  ...
  let roomImgV = {
    let roomImg = UIImage(named: "kitchen" )
  ...
  override func viewDidLoad() {
    ...
    let btnsSv = UIStackView(arrangedSubviews: [backPorchBtn])
    ...
    backPorchBtn.addTarget(self, action: #selector(goToBackPorch(_:)), for: .touchUpInside)
  }
  
  // move to another room
  @objc func goToBackPorch(_ sender: UIButton) {
    let room = BackPorchViewController()
